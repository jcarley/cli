...
var StopSubCmd = models.Command{
	...
	LongHelp: "`services stop` shuts down all running instances of a given code service. " +
		"This is useful when performing maintenance on code services and a code service must be shutdown to perform that maintenance. " +
