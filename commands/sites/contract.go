...
var CreateSubCmd = models.Command{
	...
	CmdFunc: func(settings *models.Settings) func(cmd *cli.Cmd) {
		return func(subCmd *cli.Cmd) {
			...
			enableCORS := subCmd.BoolOpt("enable-cors", false, "Add everything necessary for full CORS support")
			enableWebSockets := subCmd.BoolOpt("enable-web-sockets", false, "Add everything necessary for enabling websocket connections")
			subCmd.Action = func() {
